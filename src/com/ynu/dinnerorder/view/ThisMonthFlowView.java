...
public class ThisMonthFlowView extends JFrame {
	...
	public void init(){
		...
		Date date1=new Date();
		Date nowMonth=new Date(date1.getYear(), date1.getMonth(), 01, 00, 00, 00); 
		Date nextMonth=new Date(date1.getYear(), date1.getMonth()+1, 01, 00, 00, 00); 
