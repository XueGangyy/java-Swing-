...
import com.ynu.dinnerorder.view.FlowManageView.ButtonAction;


public class TodayFlowView extends JFrame {
	...
	public void init(){
		...
		Date date1=new Date();
		Date nowDay=new Date(date1.getYear(), date1.getMonth(), date1.getDate(), 00, 00, 00); 
		Date nextDay=new Date(date1.getYear(), date1.getMonth(), date1.getDate()+1, 00, 00, 00); 
